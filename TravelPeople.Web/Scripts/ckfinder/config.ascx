...
<%@ Import Namespace="Magsaysay.Commons.Helpers" %>
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = MiscHelpers.GetSetting("domain") + "/Content/Userfiles/";

        // The physical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath("~/Content/Userfiles/");
